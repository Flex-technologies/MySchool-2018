    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Prenom = model.Prenom, Nom = model.Nom, DateNaissance = model.DateNaissance };
                ApplicationRole role = await RoleManager.FindByIdAsync("100");
                if (role != null)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        //Ajouter l'utilisateur dans le groupe des visiteurs Guest
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult LogOffZombie()
        {
